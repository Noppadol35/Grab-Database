...
<body>
                        ...
                        <li class="nav-item dropdown">
                            <a class="nav-link dropdown-toggle" href="javascript:void(0)" data-toggle="dropdown"
                                ...
                                <span class="ml-2 d-none d-lg-inline-block"><span>Hello,</span> <span class="text-dark">
                                        admin </span> <i data-feather="chevron-down" class="svg-icon"></i></span>
                            </a>
                            ...
                            <div class="dropdown-menu dropdown-menu-right user-dd animated flipInY">
                                ...
                                <a class="dropdown-item" href="javascript:void(0)"><i data-feather="settings"
                                    ...
                                    Account Setting</a>
                                <div class="dropdown-divider"></div>
                                <a class="dropdown-item" href="index.php?logout='1'"><i data-feather="power"
                                        class="svg-icon mr-2 ml-1"></i>
                                    Logout</a>
                                <div class="dropdown-divider"></div>
                        ...
                        <div class="d-flex align-items-center">
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb m-0 p-0">
                                    <li class="breadcrumb-item"><a href="index.php">Consumer profile</a>
                                    </li>
                                </ol>
                            </nav>
                        </div>
                                    ...
                                    <table class="table no-wrap v-middle mb-0">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                    ...
                                                    <div class="d-flex align-items-center">
                                                        <form action="updataedata.php" method="post">
                                                            ...
                                                            <a href="#" class="btn btn-warning btn-rounded"
                                                                onclick="editData('<?php echo $objResult['cus_email'] ?>', '<?php echo $objResult['cus_name'] ?>', '<?php echo $objResult['cus_surname'] ?>', '<?php echo $objResult['cus_birthdate'] ?>', '<?php echo $objResult['cus_tel'] ?>','<?php echo $objResult['cus_address'] ?>','<?php echo $objResult['cus_password'] ?>')">Edit</a>
                                                ...
                                                <?php if ($objResult["cus_email"] !== "admin@gmail.com") { ?>
                                                <td class="font-weight-medium text-dark px-2 py-4 text-center">
                                                    <div class="d-flex align-items-center">
                                                        <form action="deletedata.php" method="post">
                                                            <a href="#"
                                                                class="btn waves-effect waves-light btn-rounded btn-danger delete-customer"
                                                                data-cus-email="<?php echo $objResult["cus_email"]; ?>">Remove</a>
                                                        </form>
                                                    </div>
                                                </td>
                                                <?php } else { ?>
                                                <td class="font-weight-medium text-dark px-2 py-4 text-center">
                                                    <div class="d-flex align-items-center">
                                                        <form action="deletedata.php" method="post">
                                                            <!-- Replace "Remove" button with a disabled button -->
    ...
    function insertData() {
        ...
        Swal.fire({
            ...
            html: '<form id="insert-form" class="form">' +
                ...
                '</div>' +
                '<div class="form-group">' +
                '<label for="adress" class="label font-weight-medium text-dark">Adress :</label>' +
    ...
    $(document).ready(function() {
        $('.delete-customer').click(function() {
            var cus_email = $(this).data('cus-email');
            Swal.fire({
                icon: 'warning',
                title: 'Are you sure?',
                text: 'You want to delete ' + cus_email + ' record!',
                showCancelButton: true,

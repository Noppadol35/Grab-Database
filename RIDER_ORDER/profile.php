...
<head>
   ...
   <!-- fevicon -->
   <link rel="icon" href="img/grabfood.png" type="image/gif" />
...
<body class="main-layout inner_page">
               ...
               <nav class="navigation navbar navbar-expand-md navbar-dark ">
                  ...
                  <div class="collapse navbar-collapse" id="navbarsExample04">
                     <ul class="navbar-nav mr-auto">
                        <li class="nav-item ">
                           <a class="nav-link" href="index.php?rider_email=<?php echo $row['rider_email']; ?>">Order</a>
                        </li>
   ...
   <div class="body1">
      <div class="card">
         ...
         <h2 class="name"><?php echo $row['rider_name'];?> <?php echo $row['rider_surname']?></h2>
         <div class="title">Grab driver</div>
         <div class="actions">
            <div class="follow-info">
               <h2><a href="#"><span><?php echo number_format($row['rider_salary'],2,".",","); ?></span><small>Salary</small></a></h2>
            </div>
         </div>
         <div class="desc">
            <ul>
               <br>
               <i class="fa-solid fa-phone"></i><a><strong> Phonenumber : </strong><?php echo $row['rider_tel'] ?></a>
               <br>
               <i class="fa-solid fa-cake-candles"></i><a><strong> Birthday : </strong><?php echo $row['rider_birthdate'] ?> </a>

...
$totalRecords = mysqli_fetch_array(mysqli_query($conn, "SELECT COUNT(*) FROM food_type"))[0];

// Create the pagination object
$paginator = new Paginator($totalRecords, $recordsPerPage, $page, 'page=');

// Construct the SQL query
$sql = "SELECT * FROM food_type LIMIT $offset, $recordsPerPage";
                        ...
                        <div class="d-flex align-items-center">
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb m-0 p-0">
                                    <li class="breadcrumb-item"><a href="index.php">Food category</a>
                                    </li>
                                </ol>
                            </nav>
                        </div>
                                    ...
                                    <table class="table no-wrap v-middle mb-0">
                                        <thead>
                                            <tr class="border-0">
                                                ...
                                                <th class="border-0 font-14 font-weight-medium text-muted px-2">TypeID
                                                </th>
                                                        ...
                                                        <div class="d-flex align-items-center">
                                                            <form action="updataedata.php" method="post">
                                                                ...
                                                                <a href="#" class="btn btn-warning btn-rounded"
                                                                    onclick="editData('<?php echo $objResult['type_ID'] ?>' , '<?php echo $objResult['type_name'] ?>')">Edit</a>
                                                        ...
                                                        <div class="d-flex align-items-center">
                                                            <form action="deletedata.php" method="post">
                                                                <a href="#"
                                                                    ...
                                                                    data-order="<?php echo $objResult["type_ID"]; ?>">Remove</a>
                                                            </form>
                                                        </div>
                                                    </td>
        ...
        function insertData() {
            ...
            Swal.fire({
                ...
                html:
                    ...
                    '<label for="type" class="label font-weight-medium text-dark">type:</label>' +
